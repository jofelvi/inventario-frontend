...
import { Main, Content, BackgroundContainer, FlexR, UserContainer, UserLabel, Title, Subtitle, FlexC } from '@components/views/materials/styles';
import { useAuth } from '@hooks/useAuth';
import { UserOutlined } from '@ant-design/icons';
import { Avatar } from 'antd';

const MirandaInventoryContent = () => {
...
export default MirandaInventoryContent;
